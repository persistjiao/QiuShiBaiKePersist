...
public class StatusesAPI extends AbsOpenAPI {
	...
	public void publicTimeline(int count, int page, boolean base_app,
		...
		requestAsync(SERVER_URL_PRIX + "/public_timeline.json", params,
	...
	public void friendsTimeline(long since_id, long max_id, int count,
			int page, boolean base_app, int featureType, boolean trim_user,
			RequestListener listener) {
		WeiboParameters params = buildTimeLineWithAppTrim(since_id, max_id,
				count, page, base_app, trim_user, featureType);
	...
	public void friendsTimelineIds(long since_id, long max_id, int count,
			int page, boolean base_app, int featureType,
			RequestListener listener) {
		WeiboParameters params = buildTimeLineWithApp(since_id, max_id, count,
				page, base_app, featureType);
		requestAsync(SERVER_URL_PRIX + "/friends_timeline/ids.json", params,
				HTTPMETHOD_GET, listener);
	}
	...
	public void homeTimeline(long since_id, long max_id, int count, int page,
		...
		WeiboParameters params = buildTimeLineWithAppTrim(since_id, max_id,
				count, page, base_app, trim_user, featureType);
		requestAsync(SERVER_URL_PRIX + "/home_timeline.json", params,
				HTTPMETHOD_GET, listener);
	}
	...
	public void userTimeline(String screen_name, long since_id, long max_id,
			int count, int page, boolean base_app, int featureType,
	...
	public void userTimelineIds(long uid, long since_id, long max_id,
		...
		WeiboParameters params = buildTimeLineWithApp(since_id, max_id, count,
				page, base_app, featureType);
		params.put("uid", uid);
		requestAsync(SERVER_URL_PRIX + "/user_timeline/ids.json", params,
				HTTPMETHOD_GET, listener);
	}
	...
	public void repostTimeline(long id, long since_id, long max_id, int count,
			int page, int authorType, RequestListener listener) {
		WeiboParameters params = buildTimeLineBase(since_id, max_id, count,
				page);
		params.put("id", id);
		params.put("filter_by_author", authorType);
		requestAsync(SERVER_URL_PRIX + "/repost_timeline.json", params,
				HTTPMETHOD_GET, listener);
	}
	...
	public void repostTimelineIds(long id, long since_id, long max_id,
			int count, int page, int authorType, RequestListener listener) {
		WeiboParameters params = buildTimeLineBase(since_id, max_id, count,
				page);
		params.put("id", id);
		params.put("filter_by_author", authorType);
		requestAsync(SERVER_URL_PRIX + "/repost_timeline/ids.json", params,
				HTTPMETHOD_GET, listener);
	}
	...
	public void repostByMe(long since_id, long max_id, int count, int page,
		...
		WeiboParameters params = buildTimeLineBase(since_id, max_id, count,
				page);
		requestAsync(SERVER_URL_PRIX + "/repost_by_me.json", params,
				HTTPMETHOD_GET, listener);
	}
	...
	public void mentions(long since_id, long max_id, int count, int page,
		...
		requestAsync(SERVER_URL_PRIX + "/mentions.json", params,
				HTTPMETHOD_GET, listener);
	}
	...
	public void mentionsIds(long since_id, long max_id, int count, int page,
			int authorType, int sourceType, int filterType,
			RequestListener listener) {
		WeiboParameters params = buildTimeLineBase(since_id, max_id, count,
				page);
		params.put("filter_by_author", authorType);
		params.put("filter_by_source", sourceType);
		params.put("filter_by_type", filterType);
		requestAsync(SERVER_URL_PRIX + "/mentions/ids.json", params,
				HTTPMETHOD_GET, listener);
	}
	...
	public void bilateralTimeline(long since_id, long max_id, int count,
		...
		WeiboParameters params = buildTimeLineWithAppTrim(since_id, max_id,
				count, page, base_app, trim_user, featureType);
		requestAsync(SERVER_URL_PRIX + "/bilateral_timeline.json", params,
				HTTPMETHOD_GET, listener);
	}
	...
	public void queryMID(long[] ids, int type, RequestListener listener) {
		...
		requestAsync(SERVER_URL_PRIX + "/querymid.json", params,
				HTTPMETHOD_GET, listener);
	}
	...
	public void queryID(String[] mids, int type, boolean inbox,
		...
		requestAsync(SERVER_URL_PRIX + "/queryid.json", params, HTTPMETHOD_GET,
				listener);
	}
	...
	public void hotRepostDaily(int count, boolean base_app,
		...
		requestAsync(SERVER_URL_PRIX + "/hot/repost_daily.json", params,
				HTTPMETHOD_GET, listener);
	}
	...
	public void hotRepostWeekly(int count, boolean base_app,
			RequestListener listener) {
		WeiboParameters params = buildHotParams(count, base_app);
		requestAsync(SERVER_URL_PRIX + "/hot/repost_weekly.json", params,
				HTTPMETHOD_GET, listener);
	}
	...
	public void hotCommentsDaily(int count, boolean base_app,
			RequestListener listener) {
		WeiboParameters params = buildHotParams(count, base_app);
		requestAsync(SERVER_URL_PRIX + "/hot/comments_daily.json", params,
				HTTPMETHOD_GET, listener);
	}
	...
	public void hotCommentsWeekly(int count, boolean base_app,
			RequestListener listener) {
		WeiboParameters params = buildHotParams(count, base_app);
		requestAsync(SERVER_URL_PRIX + "/hot/comments_weekly.json", params,
				HTTPMETHOD_GET, listener);
	}
	...
	public void count(String[] ids, RequestListener listener) {
		...
		requestAsync(SERVER_URL_PRIX + "/count.json", params, HTTPMETHOD_GET,
				listener);
	}
	...
	public void repost(long id, String status, int commentType,
		...
		requestAsync(SERVER_URL_PRIX + "/repost.json", params, HTTPMETHOD_POST,
				listener);
	}
	...
	public void update(String content, String lat, String lon,
		...
		requestAsync(SERVER_URL_PRIX + "/update.json", params, HTTPMETHOD_POST,
				listener);
	}
	...
	public void upload(String content, Bitmap bitmap, String lat, String lon,
		...
		requestAsync(SERVER_URL_PRIX + "/upload.json", params, HTTPMETHOD_POST,
				listener);
	}
	...
	public void uploadUrlText(String status, String imageUrl, String pic_id,
			String lat, String lon, RequestListener listener) {
		WeiboParameters params = buildUpdateParams(status, lat, lon);
		params.put("url", imageUrl);
		params.put("pic_id", pic_id);
		requestAsync(SERVER_URL_PRIX + "/upload_url_text.json", params,
				HTTPMETHOD_POST, listener);
	}
	...
	// 组装微博请求参数
	private WeiboParameters buildUpdateParams(String content, String lat,
			String lon) {
		WeiboParameters params = new WeiboParameters();
