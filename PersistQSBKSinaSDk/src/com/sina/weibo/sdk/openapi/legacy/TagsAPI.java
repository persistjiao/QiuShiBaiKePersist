...
/**
 * 该类封装了标签接口。 详情请参考<a href="http://t.cn/8F1nHUA">标签接口</a>
 * 
 * @author SINA
 * @date 2014-03-03
 */
public class TagsAPI extends AbsOpenAPI {
	...
	public void tagsBatch(String[] uids, RequestListener listener) {
		...
		requestAsync(SERVER_URL_PRIX + "/tags_batch.json", params,
	...
	public void suggestions(int count, RequestListener listener) {
		WeiboParameters params = new WeiboParameters();
		params.put("count", count);
		requestAsync(SERVER_URL_PRIX + "/suggestions.json", params,
				HTTPMETHOD_GET, listener);
	}
	 ...
	 * 
	 * @param tags
	 *            要创建的一组标签，每个标签的长度不可超过7个汉字，14个半角字符
	 * @param listener
	 *            异步请求回调接口
	 */
