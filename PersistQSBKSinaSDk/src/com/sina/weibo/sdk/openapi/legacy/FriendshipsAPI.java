...
/**
 * 此类封装了关系的接口。 详情见<a href=http://t.cn/8FUByoM">关系接口</a>
 * 
 * @author SINA
 * @date 2014-03-03
 */
public class FriendshipsAPI extends AbsOpenAPI {
	...
	public void friends(long uid, int count, int cursor, boolean trim_status,
		...
		params.put("uid", uid);
		requestAsync(SERVER_URL_PRIX + "/friends.json", params, HTTPMETHOD_GET,
				listener);
	}
	...
	public void inCommon(long uid, long suid, int count, int page,
		...
		requestAsync(SERVER_URL_PRIX + "/friends/in_common.json", params,
	...
	public void bilateral(long uid, int count, int page,
		...
		WeiboParameters params = buildFriendIDParam(uid, count);
		params.put("page", page);
		requestAsync(SERVER_URL_PRIX + "/friends/bilateral.json", params,
				HTTPMETHOD_GET, listener);
	}
	...
	public void bilateralIds(long uid, int count, int page,
		...
		WeiboParameters params = buildFriendIDParam(uid, count);
		params.put("page", page);
		requestAsync(SERVER_URL_PRIX + "/friends/bilateral/ids.json", params,
				HTTPMETHOD_GET, listener);
	}
	...
	public void friendsIds(long uid, int count, int cursor,
		...
		requestAsync(SERVER_URL_PRIX + "/friends/ids.json", params,
				HTTPMETHOD_GET, listener);
	}
	...
	public void followers(long uid, int count, int cursor, boolean trim_status,
		...
		params.put("cursor", cursor);
		params.put("trim_status", trim_status ? 1 : 0);
		requestAsync(SERVER_URL_PRIX + "/followers.json", params,
				HTTPMETHOD_GET, listener);
	}
	...
	public void followersIds(long uid, int count, int cursor,
		...
		WeiboParameters params = buildFriendIDParam(uid, count);
		params.put("cursor", cursor);
		requestAsync(SERVER_URL_PRIX + "/followers/ids.json", params,
				HTTPMETHOD_GET, listener);
	}
	...
	public void followersActive(long uid, int count, RequestListener listener) {
		WeiboParameters params = buildFriendIDParam(uid, count);
		requestAsync(SERVER_URL_PRIX + "/followers/active.json", params,
				HTTPMETHOD_GET, listener);
	}
	...
	public void chainFollowers(long uid, int count, int page,
		...
		WeiboParameters params = buildFriendIDParam(uid, count);
		params.put("page", page);
		requestAsync(SERVER_URL_PRIX + "/friends_chain/followers.json", params,
				HTTPMETHOD_GET, listener);
	}
	...
	/** 组装FriendsParam的参数 */
	private WeiboParameters buildFriendsParam(int count, int cursor,
			boolean trim_status) {
		WeiboParameters params = new WeiboParameters();
		params.put("count", count);
		params.put("cursor", cursor);
