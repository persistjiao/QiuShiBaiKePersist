...
/**
 * 此类封装了公共服务的接口。 详情见<a href="http://t.cn/8Fdg7EX">公共服务接口</a>
 * 
 * @author SINA
 * @date 2014-03-03
 */
public class CommonAPI extends AbsOpenAPI {
	 ...
	 *            省份代码
	 * @param capital
	 *            国家的首字母，a-z，可为空代表返回全部，默认为全部。 <li> {@link CommentsAPI#CAPITAL}
	 * @param language
	 *            返回的语言版本，zh-cn：简体中文、zh-tw：繁体中文、english：英文，默认为zh-cn <li>
	 *            {@link #LANGUAGE_ZH_CN} <li> {@link #LANGUAGE_ZH_TW} <li>
	 *            {@link #LANGUAGE_EN}
	 * @param listener
	 *            异步请求回调接口
	 */
	public void getCity(String province, String capital, String language,
		...
		requestAsync(SERVER_URL_PRIX + "/get_city.json", params,
	...
	public void getCountry(CAPITAL capital, String language,
		...
		params.put("language", language);
		requestAsync(SERVER_URL_PRIX + "/get_country.json", params,
				HTTPMETHOD_GET, listener);
	}
	...
	public void getTimezone(String language, RequestListener listener) {
		WeiboParameters params = new WeiboParameters();
		params.put("language", language);
		requestAsync(SERVER_URL_PRIX + "/get_timezone.json", params,
				HTTPMETHOD_GET, listener);
	}
}
