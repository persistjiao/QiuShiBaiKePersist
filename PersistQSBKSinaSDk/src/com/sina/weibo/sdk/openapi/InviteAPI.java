...
/**
 * 该类提供了好友邀请接口，支持登录用户向自己的微博互粉好友发送私信邀请、礼物。 详情请参考： <li><a
 * href="http://open.weibo.com/wiki/2/messages/invite">好友邀请接口</a> <li><a
 * href=http://t.cn/8F75vDo>申请接入流程</a>
 * 
 * @author SINA
 * @since 2013-11-04
 */
public class InviteAPI extends AbsOpenAPI {
	 ...
	 * 
	 * @param uid
	 *            被邀请人的 Uid，需要为当前用户互粉好友
	 * @param jsonData
	 *            邀请数据。以 {@link JSONObject} 数据填充
	 * @param listener
	 *            邀请接口对应的回调
	 */
	public void sendInvite(String uid, JSONObject jsonData,
			RequestListener listener) {
		if (!TextUtils.isEmpty(uid) && jsonData != null
